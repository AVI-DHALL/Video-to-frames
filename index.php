    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/cup.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/cycling.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/walk.jpg" alt="">
                            </div>
                        </div>
                    ...
                    <h1 class="brand-name">Mycurlycode Image Analysis</h1>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Try a Video 
...
$videoFile= $dst;
$imgOut="./frames/out%d.png";

$complete = system("ffmpeg.exe -i $videoFile -vf fps=2 -vsync 0 $imgOut 2>&1");

if($complete)
{
	?>
	<script>
	window.location.assign('cmp.php');
	</script>
	<?php
}

// ffmpeg -ss 4 -i input.avi -s 320x240 -frames:v 1 output.jpg                             
// ffmpeg -i Funny.mp4 -vf select='between(t,2,9)+between(t,15,24)' -vsync 0 out%d.png
// ffmpeg -i Funny.mp4 -vf select='between(t,2,9)' -vsync 0 out%d.png (this is working fine).
}
?>	
